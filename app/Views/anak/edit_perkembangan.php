...
<div class="page-content">
    ...
    <div class="ps-3">
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb mb-0 p-0">
          ...
          <li class="breadcrumb-item active" aria-current="page"><?= $perkembangan['nama'] ?></li>
        </ol>
      </nav>
    </div>
  </div>
  ...
  <div class="card">
    <div class="card-body p-4">
      <h5 class="card-title">Edit Data Perkembangan <?= $perkembangan['nama'] ?></h5>
      <hr />
            ...
            <div class="col-lg-12">
              <div class="border border-3 p-4 rounded">
                <div class="mb-3">
                  ...
                  <input type="hidden" class="form-control" id="idPerkembangan" name="idPerkembangan" placeholder="Masukkan NIP anak" value="<?= $perkembangan['id'] ?>" required>
                  <input type="text" class="form-control" id="nipAnak" name="nipAnak" placeholder="Masukkan NIP anak" value="<?= $perkembangan['nip'] ?>" required readonly>
                ...
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="namaAnak" name="namaAnak" placeholder="Masukkan nama anak" value="<?= $perkembangan['nama'] ?>" required readonly>
                  ...
                  <div class="row">
                    <div class="col-lg-4">
                      ...
                      <div class="input-group">
                        <input class="result form-control" type="text" id="tanggal" name="tanggal" placeholder="Masukkan tanggal dan waktu" value="<?= date("d/m/Y H:m", strtotime($perkembangan['waktu_rekam'])) ?>" required> <span class="input-group-text" id="basic-addon2"><i class="bx bx-calendar-exclamation"></i></span>
                      </div>
                    </div>
                  </div>
                ...
                <div class="mb-3">
                  ...
                  <div class="row">
                    <div class="col-lg-6">
                      <input type="text" class="form-control" id="tempat" name="tempat" placeholder="Masukkan tempat" value="<?= $perkembangan['tempat'] ?>" required>
                    </div>
                  </div>
                ...
                <div class="row">
                  <div class="col-lg-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="tinggiFisik" name="tinggiFisik" placeholder="Masukkan tinggi badan" value="<?= $perkembangan['tinggibadan_fisik'] ?>" required>
                  ...
                  <div class="col-lg-4 mb-3">
                    ...
                    <input type="text" class="form-control" id="beratFisik" name="beratFisik" placeholder="Masukkan berat badan" value="<?= $perkembangan['beratbadan_fisik'] ?>" required>
                    <div id="validation-beratFisik" class="invalid-feedback"></div>
                  </div>
                  <div class="col-lg-4 mb-3">
                    <label for="tekananDarahFisik" class="form-label">Tekanan Darah</label>
                    <input type="text" class="form-control" id="tekananDarahFisik" name="tekananDarahFisik" placeholder="Masukkan tekanan darah" value="<?= $perkembangan['tekanandarah_fisik'] ?>">
                    <div id="validation-tekananDarahFisik" class="invalid-feedback"></div>
                  </div>
                  <div class="col-lg-4 mb-3">
                    <label for="gulaDarahFisik" class="form-label">Gula Darah</label>
                    <input type="text" class="form-control" id="gulaDarahFisik" name="gulaDarahFisik" placeholder="Masukkan gula darah" value="<?= $perkembangan['guladarah_fisik'] ?>">
                    <div id="validation-gulaDarahFisik" class="invalid-feedback"></div>
                  </div>
                  <div class="col-lg-4 mb-3">
                    <label for="kolesterolFisik" class="form-label">Kolesterol</label>
                    <input type="text" class="form-control" id="kolesterolFisik" name="kolesterolFisik" placeholder="Masukkan kolesterol" value="<?= $perkembangan['kolesterol_fisik'] ?>">
                    <div id="validation-kolesterolFisik" class="invalid-feedback"></div>
                  </div>
                  <div class="col-lg-4 mb-3">
                    <label for="fungsiParuFisik" class="form-label">Fungsi Paru</label>
                    <input type="text" class="form-control" id="fungsiParuFisik" name="fungsiParuFisik" placeholder="Masukkan fungsi paru" value="<?= $perkembangan['fungsiparu_fisik'] ?>">
                  ...
                  <div class="col-lg-12 mb-3">
                    ...
                    <textarea name="keteranganFisik" id="keteranganFisik" class="form-control" rows="3" placeholder="Masukkan keterangan fisik"><?= $perkembangan['keterangan_fisik'] ?></textarea>
                ...
                <div class="mb-3">
                  ...
                  <textarea name="percayadiri" id="percayadiri" class="form-control" rows="2" placeholder="Masukkan kepercayaan diri"><?= $perkembangan['percayadiri_pskologis'] ?></textarea>
                  <div id="validation-percayadiri" class="invalid-feedback"></div>
                </div>
                <div class="mb-3">
                  <label for="mandiri" class="form-label">Kemandirian Diri</label>
                  <textarea name="mandiri" id="mandiri" class="form-control" rows="2" placeholder="Masukkan kemandirian diri"><?= $perkembangan['mandiri_pskologis'] ?></textarea>
                  <div id="validation-mandiri" class="invalid-feedback"></div>
                </div>
                <div class="mb-3">
                  <label for="disiplin" class="form-label">Kedisiplinan</label>
                  <textarea name="disiplin" id="disiplin" class="form-control" rows="2" placeholder="Masukkan kedisiplinan"><?= $perkembangan['disiplin_pskologis'] ?></textarea>
                  <div id="validation-disiplin" class="invalid-feedback"></div>
                </div>
                <div class="mb-3">
                  <label for="tanggungjawab" class="form-label">Tanggung Jawab</label>
                  <textarea name="tanggungjawab" id="tanggungjawab" class="form-control" rows="2" placeholder="Masukkan tanggung jawab"><?= $perkembangan['tanggungjawab_pskologis'] ?></textarea>
                ...
                <div class="mb-3">
                  ...
                  <textarea name="keteranganPsikologis" id="keteranganPsikologis" class="form-control" rows="3" placeholder="Masukkan keterangan psikologis"><?= $perkembangan['keterangan_pskologis'] ?></textarea>
                ...
                <div class="mb-3">
                  ...
                  <textarea name="penyesuaian" id="penyesuaian" class="form-control" rows="2" placeholder="Masukkan penyesuaian diri"><?= $perkembangan['penyesuaian_sosial'] ?></textarea>
                  <div id="validation-penyesuaian" class="invalid-feedback"></div>
                </div>
                <div class="mb-3">
                  <label for="kerjasama" class="form-label">Kerjasama</label>
                  <textarea name="kerjasama" id="kerjasama" class="form-control" rows="2" placeholder="Masukkan kerjasama"><?= $perkembangan['kerjasama_sosial'] ?></textarea>
                  <div id="validation-kerjasama" class="invalid-feedback"></div>
                </div>
                <div class="mb-3">
                  <label for="sopan" class="form-label">Sopan Santun</label>
                  <textarea name="sopan" id="sopan" class="form-control" rows="2" placeholder="Masukkan sopan santun"><?= $perkembangan['sopan_sosial'] ?></textarea>
                  <div id="validation-sopan" class="invalid-feedback"></div>
                </div>
                <div class="mb-3">
                  <label for="keteranganSosial" class="form-label">Keterangan Sosial</label>
                  <textarea name="keteranganSosial" id="keteranganSosial" class="form-control" rows="3" placeholder="Masukkan keterangan sosial"><?= $perkembangan['keterangan_sosial'] ?></textarea>
                ...
                <div class="mb-3">
                  ...
                  <textarea name="gambaran" id="gambaran" class="form-control" rows="2" placeholder="Masukkan gambaran permasalahannya"><?= $perkembangan['gambaran_masalah'] ?></textarea>
                ...
                <div class="mb-3">
                  ...
                  <textarea name="penyeselaian" id="penyeselaian" class="form-control" rows="2" placeholder="Masukkan pemecahan masalah"><?= $perkembangan['penyelesaian_masalah'] ?></textarea>
                ...
                <div class="mb-3">
                  ...
                  <textarea name="perubahan" id="perubahan" class="form-control" rows="2" placeholder="Masukkan perubahan masalah"><?= $perkembangan['perubahan_masalah'] ?></textarea>
                ...
                <div class="mb-3">
                  ...
                  <textarea name="keteranganPermasalahan" id="keteranganPermasalahan" class="form-control" rows="3" placeholder="Masukkan keterangan permasalahan"><?= $perkembangan['keterangan_masalah'] ?></textarea>
...
<script type="text/javascript">
  $(document).ready(function() {
    ...
    $("#formAnak").on('submit', function(event) {
      ...
      $.ajax({
        url: '<?= base_url() ?>anak/proses?act=update_perkembangan',
        type: 'POST',
        data: formdata,
        processData: false,
        contentType: false,
