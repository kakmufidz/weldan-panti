            ...
            <div class="dropdown-menu dropdown-menu-end">
              <div class="row row-cols-3 g-3 p-3">
                <div class="col text-center">
                  <a href="<?= base_url('dashboard') ?>" class="app-box mx-auto bg-gradient-blues text-white"><i class='bx bx-home-circle'></i>
                  </a>
                  <div class="app-title">Dashboard</div>
                </div>
                <div class="col text-center">
                  <a href="<?= base_url('anak') ?>" class="app-box mx-auto bg-gradient-cosmic text-white"><i class='bx bx-group'></i>
                  </a>
                  <div class="app-title">Anak Asuh</div>
                </div>
                <!-- <div class="col text-center">
